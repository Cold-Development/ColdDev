...
public class CommandContext {
    ...
    public CommandContext(ColdPlugin coldPlugin, CommandSender sender, String commandLabel, String[] rawArguments) {
     ...
     */
    public ColdPlugin getColdPlugin() {
        return this.coldPlugin;
    }
